        ...
        <div class="row mt-5">
          <div class="col-12">
            <div class="heading-title">
              <h4 class="display-4 fw-bold text-white title-dark">广告营销</h4>
              <p class="text-white-50 para-desc mb-0">精准获客利器。按实际效果付费，助力企业营销获客。</p>
            </div>
          </div><!--end col-->
        </div><!--end row-->
      </div><!--end container-->
          ...
          <div class="row">
            <div class="col-lg-2 col-md-4 mt-4 pt-2">
              <div class="card border-0 text-center features feature-primary core-feature shadow rounded p-4">
                ...
                <div class="card-body p-0 mt-4">
                  <a href="javascript:void(0)" class="title text-dark h5">百度广告</a>
                </div>
              </div>
            </div><!--end col-->
            ...
            <div class="col-lg-2 col-md-4 mt-4 pt-2">
              <div class="card border-0 text-center features feature-primary core-feature shadow rounded p-4">
                ...
                <div class="card-body p-0 mt-4">
                  <a href="javascript:void(0)" class="title text-dark h5">微信广告</a>
                </div>
              </div>
            </div><!--end col-->
            ...
            <div class="col-lg-2 col-md-4 mt-4 pt-2">
              <div class="card border-0 text-center features feature-primary core-feature shadow rounded p-4">
                <div class="icon text-center mx-auto rounded-md">
                  <h3 class="mb-0"><i class="uil uil-bitcoin"></i></h3>
                </div>
                <div class="card-body p-0 mt-4">
                  <a href="javascript:void(0)" class="title text-dark h5">360广告</a>
                </div>
              </div>
            </div><!--end col-->
            ...
            <div class="col-lg-2 col-md-4 mt-4 pt-2">
              <div class="card border-0 text-center features feature-primary core-feature shadow rounded p-4">
                <div class="icon text-center mx-auto rounded-md">
                  <h3 class="mb-0"><i class="uil uil-gold"></i></h3>
                </div>
                <div class="card-body p-0 mt-4">
                  <a href="javascript:void(0)" class="title text-dark h5">微博广告</a>
                </div>
              </div>
            </div><!--end col-->
            ...
            <div class="col-lg-2 col-md-4 mt-4 pt-2">
              <div class="card border-0 text-center features feature-primary core-feature shadow rounded p-4">
                <div class="icon text-center mx-auto rounded-md">
                  <h3 class="mb-0"><i class="uil uil-building"></i></h3>
                </div>
                <div class="card-body p-0 mt-4">
                  <a href="javascript:void(0)" class="title text-dark h5">搜狗广告</a>
                </div>
              </div>
            </div><!--end col-->
